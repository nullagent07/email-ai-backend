...
Revision ID: 6fc276a2c60d
Revises: 
Create Date: 2024-11-16 13:54:08.423809
...
def upgrade() -> None:
    ...
    op.create_table('open_ai_threads',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    op.create_table('gmail_threads',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('open_ai_thread_id', sa.String(), nullable=False),
    sa.Column('recipient_email', sa.String(), nullable=False),
    sa.Column('sender_email', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['open_ai_thread_id'], ['open_ai_threads.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
